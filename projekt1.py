...
with DAG(
    ...
    params={
      "dags_home": Param("/home/username/airflow/dags", type="string"),
      "input_dir": Param("gs://bucket/hive-project/input", type="string"),
      "output_mr_dir": Param("/hive-project/output_mr3", type="string"),
      "output_dir": Param("/hive-project/output6", type="string"),
...
{{ params.dags_home }}/project_files/comb.py,\
{{ params.dags_home }}/project_files/reductor.py \
...
""",
  ...
  hive = BashOperator(
    ...
    bash_command="""beeline -u jdbc:hive2://localhost:10000/default \
      -f {{ params.dags_home }}/project_files/final.hql \
      --hivevar devs_file={{ params.input_dir }}/datasource4 \
      --hivevar apps_file={{ params.output_mr_dir }} \
      --hivevar out_file={{ params.output_dir }}""",
  )
